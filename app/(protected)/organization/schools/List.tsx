...
export function List() {
  ...
  const list = useSelector((state: RootState) => state.list.value) as SchoolWithHead[];

  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalAddOpen, setModalAddOpen] = useState(false);
  const [selectedItem, setSelectedItem] = useState<SchoolWithHead | null>(null);

  const handleDeleteConfirmation = (item: SchoolWithHead) => {
    setSelectedItem(item);
    setIsModalOpen(true);
  };

  const handleEdit = (item: SchoolWithHead) => {
    setSelectedItem(item);
        ...
        <table className="app__table">
          <thead className="app__table_thead">
            <tr>
              ...
              <th className="app__table_th">School Head</th>
